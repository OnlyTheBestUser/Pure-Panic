...
namespace NCL {
	namespace CSC8503 {
		...
		public:
			...
			Projectile* SpawnProjectile(Player* owner, const bool& IsMultiBulletOn, const float& initialSpeed = 70.0f, const float& meshSize = 0.5f);
			Projectile* SpawnProjectile(GameObject* owner, const bool& IsMultiBulletOn, float pitch, int playerID, const float& initialSpeed = 70.0f, const float& meshSize = 0.5f);
